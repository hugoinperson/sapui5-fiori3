sap.ui.define(["sap/ui/base/Object", "sap/m/MessageBox"], function(UI5Object, MessageBox) {
	...
	return UI5Object.extend("be.wl.PersonSkills.controller.ErrorHandler", {
		/**
		 * Handles application errors by automatically attaching to the model events and displaying errors when needed.
		 * @class
		 * @param {sap.ui.core.UIComponent} oComponent reference to the app's component
		 * @public
		 * @alias be.wl.PersonSkills.controller.ErrorHandler
		 */
		constructor: function(oComponent) {
			...
			console.log("eee", this._oModel.getMetadata());
